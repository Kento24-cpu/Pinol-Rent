...
const SELECT = 'id, brand, model, year, price_per_day, deposit, available, image_url, avg_rating, reviews_count, department:department_id(name), profile:owner_id(full_name, business_name), car_tags(tag:tag_id(name))'
